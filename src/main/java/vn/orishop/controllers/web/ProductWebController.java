...
public class ProductWebController extends HttpServlet {
    ...
    private void listPromotionalProducts(HttpServletRequest req, HttpServletResponse resp)
            throws ServletException, IOException {
        ...
        if (id != null) {
            ...
            if (product.getCategory() != null) {
                List<Product> relatedProducts =
                        productService.findByCategoryId(product.getCategory().getCategoryId());
    ...
    private String updateRecentViewedCookie(
            HttpServletRequest req, HttpServletResponse resp, String currentId) {
        String txt = "";

...
public class ProductController extends HttpServlet {
        ...
        try {
            ...
            String savedFileName =
                    UploadUtils.processUpload(
                            "image", request, Constant.DIR + "/product", fileName);
    ...
    protected void edit(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (id != null) {
                ...
                request.getRequestDispatcher("/views/admin/product/edit.jsp")
            ...
            try {
                ...
                if (p != null) {
                    ...
                    request.setAttribute(
                            "message",
                            "Sản phẩm đã có đơn hàng, hệ thống đã chuyển sang trạng thái 'Ngừng bán'!");
                } else {
    ...
    protected void update(HttpServletRequest request, HttpServletResponse response) {
        try {
                ...
                if (oldProduct.getImage() != null && !oldProduct.getImage().isEmpty()) {
                    ...
                    String deletePath =
                            request.getServletContext()
                                    .getRealPath(Constant.DIR + "/product/" + fname);
            ...
            request.setAttribute(
                    "listCate",
                    categoryService.findAll()); // Load lại danh mục để dropdown không rỗng

...
@WebServlet(urlPatterns = { "/admin/categories", "/admin/category/create", "/admin/category/update",
        ...
        try {
            ...
            if (request.getPart("icon").getSize() == 0) {
                ...
                if (oldCate.getIcon() != null && !oldCate.getIcon().isEmpty()) {
                    ...
                    String deletePath = request.getServletContext().getRealPath(Constant.DIR + "/category/" + fname);

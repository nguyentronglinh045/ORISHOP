<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
        ...
        <head>
            <title>Quên mật khẩu - OriShop</title>
        </head>
                        ...
                        <p class="forgot-description">
                            <c:choose>
                                <c:when test="${step == 'verify'}">
                                    Mã xác thực 6 số đã được gửi đến email của bạn. Vui lòng kiểm tra hộp thư (kể cả mục
                                    Spam).
                                </c:when>
                                ...
                                <c:otherwise>
                                    Nhập địa chỉ email đã đăng ký và chúng tôi sẽ gửi mã xác thực để đặt lại mật khẩu
                                    cho bạn.
                                </c:otherwise>
                            </c:choose>
                        </p>

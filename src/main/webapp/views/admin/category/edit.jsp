			...
			<div>
				...
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb mb-0">
						...
						<li class="breadcrumb-item"><a
							href="<c:url value='/admin/categories'/>">Danh mục</a></li>
						...
						<div class="form-group mb-4">
							...
							<div class="input-group">
								<span class="input-group-text"><i
									class="fas fa-code-branch"></i></span> <select class="form-select"
						...
						<c:if test="${not empty cate.icon}">
							<div class="mb-4">
								...
								<div class="current-image-wrapper">
									<img
										src="<c:url value='/assets/uploads/category/${cate.icon}'/>"
										alt="${cate.categoryName}" class="current-image"> <span
										class="badge-current"> <i class="fas fa-image me-1"></i>Ảnh
										hiện tại
									</span>
								</div>
							</div>
						...
						<div class="form-group mb-4">
							...
							<div class="file-upload-wrapper">
								<input type="file" class="form-control" id="icon" name="icon"
									...
									for="icon" class="file-upload-label"> <i
									class="fas fa-cloud-upload-alt me-2"></i> <span
									class="file-label-text">Chọn hình ảnh mới</span>
								</label>
							</div>
...
.file-upload-label {
	...
	text-align: center;
	background: #f8f9fa;
	cursor: pointer; /* Quan trọng: Hình bàn tay */

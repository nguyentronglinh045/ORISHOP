                            ...
                            <div class="product-item">
                                ...
                                <div class="product-info">
                                    ...
                                    <c:if test="${empty p.description}">
                                        <p class="product-description text-muted fst-italic">Chưa có mô tả</p>
                                    </c:if>
                                    ...
                                    <div class="product-actions">
                                        <a href="<c:url value='/admin/product/edit?id=${p.productId}'/>" class="btn-edit">
                                            <i class="fas fa-edit"></i>Sửa
                                        </a>
                                        <a href="<c:url value='/admin/product/delete?id=${p.productId}'/>" class="btn-delete"
                        ...
                        <div class="pagination-wrapper">
                            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                                <div class="pagination-info">
                                    ...
                                    <strong>${currentPage * pageSize > totalProducts ? totalProducts : currentPage * pageSize}</strong>
                                    ...
                                    <ul class="pagination">
                                        ...
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                ...
                                                <c:forEach begin="${currentPage - 1 > 1 ? currentPage - 1 : 2}"

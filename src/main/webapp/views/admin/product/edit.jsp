<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
        <%@ taglib prefix="fmt" uri="jakarta.tags.fmt" %>
            ...
            <head>
                <title>Sửa Sản phẩm - ORISHOP Admin</title>
            </head>
                        ...
                        <form action="<c:url value='/admin/product/update'/>" method="post"
                            ...
                            <div class="row form-row">
                                <div class="col-md-4 mb-3 mb-md-0">
                                    ...
                                    <div class="form-text">Giá gốc (VNĐ)</div>
                                </div>
                                ...
                                <div class="col-md-4 mb-3 mb-md-0">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" id="discount" name="discount"
                                            value="${product.discount}" min="0" max="100" placeholder="0">
                                    </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-text">Tồn kho</div>
                                </div>
                            </div>
